...
int main () {
    ...
    if ( comp < 0 || alt < 0 || larg < 0 || vlrlata < 0 || rend < 0) {
        ...
        if ( ap <= rend && ap >= rend )
            ...
            latasp = ceil(ap / rend);
            gastop = latasp * vlrlata;
                printf("\n\ta) Para pintar a parte interna da caixa, será preciso: %.0f", latasp);
                printf(" latas de tinta e gastará R$ %.2f", gastop);
                printf("\n");
                printf("\n===================================================================================================");
        ...
        if ( ap <= rend && ap >= rend )
            ...
            gastop = latasp * vlrlata;
                printf("\n");
                printf("\n\tb) Para pintar a parte externa da caixa, será preciso: %.0f", latasp);
                printf(" latas de tinta e gastará R$ %.2f", gastop);
                printf("\n");
                printf("\n===================================================================================================");
        ...
        if ( at <= rend && at >= rend )
            ...
            gastot = latast * vlrlata;
                printf("\n");
                printf("\n\tc) Para pintar toda caixa, será preciso: %.0f", latast);
                printf(" latas de tinta e gastará R$ %.2f", gastot);
                printf("\n");
                printf("\n===================================================================================================");
